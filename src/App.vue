                  ...
                  <div class="row">
                    <div class="menu-info d-flex justify-content-between align-items-center">
                      <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                        href="index.html" class="logo"> <img src="@/assets/images/logo/logo-5.png" width="145" height="44"
                                                             alt="logo"> </a>
          ...
          <div class="d-lg-block d-none">
            <div class="row g-0 position-relative">
              <div class="col-lg-3 d-flex align-items-center justify-content-center border-rit ">
                <div class="logo"> <a href="index.html"> <img src="@/assets/images/logo/logo.png" alt="111"> </a>
                </div>
              </div>
      ...
      <div class="side-cart d-flex flex-column justify-content-between">
        ...
        <div class="bottom">
          ...
          <div class="button-box d-flex justify-content-between">
            <router-link :to="{name: 'cart.index'}"> View Cart </router-link>
