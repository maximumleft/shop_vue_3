            ...
            <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
              <div class="single-product-box one">
                <div class="big-product single-product-one slider-for">
                  <div>
                    <div class="single-item"> <img :src="product.preview_image" alt="">
                      <div class="ptag"> </div> <a href="#0"
                                                                                  class="love"> <i class="flaticon-like"></i> </a>
                    </div>
                  </div>
                  <div>
                    <div class="single-item"> <img :src="product.second_image" alt="">
                      <div class="ptag"> </div> <a href="#0"
                                                                                  class="love"> <i class="flaticon-like"></i> </a>
                    </div>
                  </div>
            ...
            <div class="col-xl-6 col-lg-6 mt-30 wow fadeInUp animated">
              <div class="shop-details-top-right ">
                <div class="shop-details-top-right-content-box">
                    ...
                    <div class="product-quantity-box d-flex align-items-center flex-wrap">
                      <div class="qty mr-2">
                        <div class="qtySelector text-center"> <span class="decreaseQty">
                          <i @click.prevent="qtyMinus" class="flaticon-minus"></i>
                        </span> <input type="number"  :value="this.qty" />
                          <span class="increaseQty">
                            <i @click.prevent="qtyPlus" class="flaticon-plus"></i> </span> </div>
                      </div>
                  ...
                  <div class="shop-details-top-cart-box-btn"> <button @click.prevent="addToCart(product.id)" class="btn--primary style2 "
                  ...
                  <ul class="shop-details-top-category-tags">
                    <li>Category: <span>{{category.title}}</span></li>
                    <li>Tags:
                      <span v-for="tags in product.tags">{{tags.title}}</span>
                    </li>
                  </ul>
